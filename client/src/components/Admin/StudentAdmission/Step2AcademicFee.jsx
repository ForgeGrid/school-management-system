    ...
    <div className="flex flex-col h-full bg-transparent">
      ...
      >
        ...
        <div className="mb-5">
          ...
          <p className="text-base text-slate-450 mt-1">Step 2 of 4 &bull; Confirm the academic and transport fee plan for this student</p>
        </div>

        {/* Callout Info Banner */}
        <div className="mb-6 bg-blue-50/65 border border-blue-100 rounded-xl px-5 py-3.5 flex items-center justify-between text-base text-blue-700 shadow-2xs">

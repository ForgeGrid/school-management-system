...
import { TrendingUp, FileText, Download, MessageSquare, Settings, Save } from "lucide-react";
...
// Academic sub-components
import { Attendece } from "@/components/Admin/Acadameic/Attendance";
...
export default function AdminDashboard() {
  ...
  const TAB_TO_URL = {
    ...
    "Academic › Class Section":     "/academic/class-section",
    "Academic › My Class":          "/academic/my-class",
    // ──────────────────────────────────────────────────────────────────────
  ...
  // On first load, redirect bare /dashboard/admin to dashboard
  useEffect(() => {
  ...
  return (
      <TooltipProvider>
        <SidebarProvider defaultOpen={true}>
          <div className="flex h-screen w-full overflow-hidden bg-white-900 hide-scrollbar">
              ...
              <main className="flex-1 overflow-hidden p-6 md:p-8 flex flex-col">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    {activeTab === "Academic › Class Section" && (
                      <ClassSection />
                    )}
                    {activeTab === "Academic › My Class" && (
                      <Myclass />
                    )}

      ...
      <div className="relative z-10 flex flex-col h-screen overflow-hidden">
        ...
        <header className="w-full flex items-center justify-end px-4 md:px-6 py-3 md:py-4 bg-transparent z-50 shrink-0">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <Button variant="outline" className="flex items-center gap-2 bg-white/90 hover:bg-slate-50 shadow-sm border border-gray-200 rounded-full px-3 md:px-4 py-2 md:py-2.5 transition-all text-slate-700 hover:text-red-600">

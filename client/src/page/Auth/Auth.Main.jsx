...
import { Astroid, Users, BarChart2, ShieldCheck, BadgeCheck, Lock } from "lucide-react";
      ...
      <div className="flex w-full h-full">
        ...
        <div className="hidden lg:flex flex-col justify-between bg-white w-[55%] h-full px-10 xl:px-14 py-6 overflow-hidden">
          <div className="flex flex-col gap-5 min-h-0">
            ...
            <div className="inline-flex items-center gap-2 bg-indigo-50 px-4 py-2 rounded-full w-fit">
              <Astroid className="w-4 h-4 text-indigo-500 shrink-0" />
            ...
            <div className="flex justify-center">
              <img src={School} alt="school" className="w-full max-w-[560px] object-contain" />
            </div>
          </div>

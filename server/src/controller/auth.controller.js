    ...
    <body style="margin: 0; padding: 0; background-color: #ffffff; font-family: 'Poppins', sans-serif;">
        <div style="max-width: 600px; margin: 40px auto; background: #ffffff; color: #1e293b; padding: 48px 40px; border-radius: 20px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
            ...
            <div style="text-align: center; margin: 40px 0;">
                <a href="https://school-management-system-alpha-two.vercel.app/dashboard/" style="background: linear-gradient(135deg, #2563eb, #7c3aed); color: #ffffff !important; text-decoration: none; padding: 18px 36px; border-radius: 12px; font-weight: 700; font-size: 18px; display: inline-block; box-shadow: 0 10px 20px rgba(37, 99, 235, 0.2);">
                    Launch My Dashboard →
                </a>
            </div>
